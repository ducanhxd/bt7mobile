  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.viewtop1}>
        <Ips Text="Email" placeholder="Username" />
      </View>
      <View style={styles.viewtop1}>
        <Ipspass Text="Password" placeholder="Password" />
      </View>
      <View style={styles.btn}>
        <Btns color="#D4F1F4" Text="Sign In"></Btns>
        {/* <Text style={styles.ortext}>OR</Text> */}
        <Btns color="#D4F1F4" Text="Gmail Login"></Btns>
        <Btns
          color="#D4F1F4"
